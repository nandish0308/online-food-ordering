...
export const CREATE_EVENTS_REQUEST="CREATE_EVENTS__REQUEST";
export const CREATE_EVENTS_SUCCESS="CREATE_EVENTS__SUCCESS";
export const CREATE_EVENTS_FAILURE="CREATE_EVENTS__FAILURE";
